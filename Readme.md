...
- Є кнопка для симуляції відправки евента в анатлітику та лог усіх івентів які відбувалися до цього
...
7. Background / Foreground - Відкрив WebView, згорнув додаток, повернувся - усе працює корректно.
...
Також реалізований окремий діп ліне який обробляє кнопку з політики і відкривається екран з webview
